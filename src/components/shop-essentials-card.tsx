  ...
  return (
    <div
      className={cn(
        ...
        solidContentCard,
        glassCardHover,
        "border-amber-200/60 bg-gradient-to-br from-amber-50 to-orange-50 dark:border-amber-900/40 dark:from-amber-950/20 dark:to-orange-950/10"
      )}
    >
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          ...
          <a
            ...
            className="mt-3 inline-flex items-center gap-1 text-sm font-medium text-amber-800 transition-colors hover:text-amber-900 dark:text-amber-100 dark:hover:text-amber-50"
          >
            Browse on Amazon
